 ...
 * Tupelo managed disk classes which offer the user an InputStream
 * interface for reading data.
 *
 * @see StreamOptimizedDisk.InputStream
 */

abstract public class ManagedDiskInputStream extends InputStream {
	protected ManagedDiskInputStream( long size ) {
		this.size = size;
		posn = 0;
	}
